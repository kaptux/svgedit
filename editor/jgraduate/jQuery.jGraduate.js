    ...
    return this.each(function() {
      ...
      gradPicker.html(
        '<div id="' +
          ...
          '<div class="jGraduate_StopSection" style="display:none">' +
          ...
          '<div class="jGraduate_StopSection center_point">' +
          ...
          '<div class="jGraduate_Form_Section match_center">' +
          '<label>Match center: <input type="checkbox" checked="checked" id="' +
          id +
          '_jGraduate_match_ctr"/></label><br/>' +
          ...
          'rangearrows2.gif">' +
          "</div>" +
          '<label>Radius:&nbsp;<input type="text" id="' +
          id +
          ...
          'rangearrows2.gif">' +
          "</div>" +
          '<label>Ellip:&nbsp;<input type="text" id="' +
          id +
          ...
          'rangearrows2.gif">' +
          "</div>" +
          '<label>Angle:&nbsp;<input type="text" id="' +
          id +
          '_jGraduate_AngleInput" size="3" value="0"/>deg</label>' +
          "</div>" +
      ...
      const spreadMethodOpt = gradPicker
      ...
      colPicker.jPicker(
        ...
        function(clr) {
          ...
          $this.paint.alpha = clr.val("ahex")
            ? Math.round((clr.val("a") / 255) * 100)
            : 100;
